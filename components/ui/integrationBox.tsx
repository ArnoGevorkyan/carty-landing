  ...
  return (
    <>
      ...
      <div className="hidden lg:block">
        ...
        <div className="absolute right-24 top-14 scale-y-105 opacity-30 hidden">
          <svg
            width="554"
            height="543"
            viewBox="0 0 554 543"
        ...
        {/* Integration Cards */}
        <div className="absolute right-56 top-24 flex flex-col gap-10 hidden">
      ...
      <div className="block w-full lg:hidden">
        <div className="relative mx-auto max-w-sm">
          ...
          <div className="absolute inset-0 flex scale-110 items-center justify-center hidden">
            <svg
              width="316"
              height="321"
              viewBox="0 0 316 321"
          ...
          <div className="relative flex -translate-y-2 scale-90 flex-col gap-8 hidden">
