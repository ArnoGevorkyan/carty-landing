    ...
    <section className={'mt-36'}>
      ...
      >
        ...
        <p className="mt-4 max-w-2xl text-center text-gray-500">
          Carty&apos;s mission is to reduce the time it takes for you to go from
          idea to creation. The first time you may have seen us, you saw our
          MVP. Today, here’s our V1, and how we’re building for the future of
          coding with AI.
          <br /> <br />
      ...
      <div className="mt-10 flex flex-col items-center justify-center">
        ...
        <div className="m-4 mt-2 flex max-w-4xl flex-wrap items-center justify-center gap-4">
          <Badge className="border-primary-900/30 bg-primary-300/10 font-medium text-primary-800 dark:text-primary-700">
            Carty Inventory: Best AI tools integrated into one UX
          </Badge>
          <Badge className="border-primary-900/30 bg-primary-300/10 font-medium text-primary-800 dark:text-primary-700">
            Carty Chat: Talk to your code
          </Badge>
          <Badge className="border-primary-900/30 bg-primary-300/10 font-medium text-primary-800 dark:text-primary-700">
            Carty Creator: Automatic code generation
          </Badge>
          <Badge className="border-primary-900/30 bg-primary-300/10 font-medium text-primary-800 dark:text-primary-700">
            Carty Search: Up-to-date AI search
          </Badge>
          <Badge className="border-primary-900/30 bg-primary-300/10 font-medium text-primary-800 dark:text-primary-700">
      ...
      <div className="mt-10 flex flex-col items-center justify-center p-4 pb-0">
        ...
        <div className="max-w-2xl text-gray-500">
          <p className="mt-6 text-center">
            Carty is fueled by its most important thing, the community. Join our
            Discord with +2000 developers and friends all trying to create the
            best AI code editor in the world together.
          </p>
        </div>
      </div>
      <br />
      ...
      <div className="mt-0 flex flex-col items-center justify-center p-4 pb-0">
        ...
        <div className="max-w-2xl text-gray-500">
          <p className="mt-6 text-center">
            Carty is founded by Pan and Nang, both software engineers who worked
            on internal and developer tooling teams at companies like Meta,
            Coinbase, Two Sigma, among others. Together, they have over 500k
      ...
      <div className="mt-10 flex flex-col items-center justify-center p-4 pb-0">
        ...
        <p className="mt-4 max-w-2xl text-center text-gray-500">
          ...
          future, we envision Carty as a framework for all AI tools to live and
