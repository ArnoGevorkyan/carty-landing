          ...
          <div className="mx-auto max-w-3xl">
            <article>
              ...
              <div className="mt-8 space-y-8 text-gray-600 dark:text-gray-400">
                <section>
                  <h2 className="h3 mb-4 text-gray-900 dark:text-gray-100">
                    Introduction
                  </h2>
                  <p>
                    Carty ("we", "our", or "us") is committed to protecting your
                    privacy. This Privacy Policy explains how we collect, use,
                    and safeguard your information when you use our Telegram
                    Mini App service ("Service").
                  </p>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 mt-2">
                    <li>
                      Telegram account information when you connect to our
                      service
                    </li>
                ...
                <section>
                  ...
                  <p>
                    ...
                    personal information. Your data is stored securely on our
                    servers and is only accessible to authorized personnel.
                  </p>
                </section>
