...
const defaultMetadata = {
  title: 'Carty: Shopify for messenger-based stores',
  description:
    'Carty is a no-code constructor for Telegram shops that helps you create and manage digital product stores.',
};
