...
<div align="center">
  <div align="center">
    <img src="components/ui/CartyLogo.svg" alt="Carty Logo" />
  </div>
  <h3 align="center">Carty Landing Page</h3>
  <p align="center">
    The Open Source AI-powered code editor
    <br />
    <a href="https://trycarty.com"><strong>Explore the Website »</strong></a>
    <br />
    <br />
    <a href="https://github.com/carty/carty-landing-page/issues">Report Bug</a>
    ·
    <a href="https://github.com/carty/carty-landing-page/issues">Request Feature</a>
  </p>
</div>
...
This is the landing page for [Carty:](https://trycarty.com) the Open Source AI-powered code editor. This product is managed by [Nang](https://youtube.com/nang88) and [Pan](https://youtube.com/FryingPan).
...
1.  Clone the repo
    ```sh
    git clone https://github.com/carty/carty-landing-page.git
    ```
...
2. Clone the repo
   ```sh
   git clone https://github.com/<USERNAME>/carty-landing-page.git
   ```
3. Navigate to the project directory
   ```sh
   cd carty-landing-page
   ```
